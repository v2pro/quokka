...
field
    :   'repeated'? pbtype fieldName '=' fieldNumber ('[' fieldOptions ']')? ';'
    ;
...
oneofField
    :   pbtype fieldName '=' fieldNumber ('[' fieldOptions ']')? ';'
    ;

// Map field

mapField
    :   'map' '<' keyType ',' pbtype '>' mapName '=' fieldNumber ('[' fieldOptions ']')? ';'
    ;
